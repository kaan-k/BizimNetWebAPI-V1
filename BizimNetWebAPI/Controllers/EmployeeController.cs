...
namespace BizimNetWebAPI.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        [HttpPost("Update")]
        public IActionResult Update(EmployeeDto employee, int employeeId) // ✅ Changed string -> int
        {
        ...
        public IActionResult AssignToDepartment(int employeeId, int departmentId) // ✅ Changed string -> int
        {
        ...
        [HttpPost("AssignRole")]
        public IActionResult AssignRole(int employeeId, string role) // ✅ Changed string -> int
        {
        ...
        public IActionResult GetByDepartmentId(int departmentId) // ✅ Changed string -> int
        {
        ...
        public IActionResult GetManagerByDepartment(int departmentId) // ✅ Changed string -> int
        {
        ...
        public IActionResult GetCountByDepartment(int departmentId) // ✅ Changed string -> int
        {
